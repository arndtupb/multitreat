...
Writing an article with Quarto Markdown allows you to switch between coding languages at your will. Easiest is the implementation of R and Python, but access to Stata works too. You can either import Stata output as .tex-files, e.g. by the courtesy of Stata's user written estout package or you immediately call Stata from within Quarto Markdown with the Statamarkdown package for R.
...
library(rsvg)
magick::image_read_svg("../output/fig_twfe.svg")
```
